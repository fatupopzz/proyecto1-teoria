...
| 4 | Minimización del AFD | `src/minimizacion.py` | 3 |
...
- **Minimización:** antes de refinar se completa el AFD con un estado trampa
  (el algoritmo requiere una función de transición total). Al terminar se
  eliminan los estados inalcanzables y los estados muertos, y se renumeran los
  estados restantes desde 0, dejando el inicial como el estado 0.
